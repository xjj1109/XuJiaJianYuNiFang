...
public class GriedView6_XiangQing extends AppCompatActivity implements View.OnClickListener {
...
//                增加
            ...
            case R.id.fenxiang:
                //  Toast.makeText(this, "sss", Toast.LENGTH_SHORT).show();
                vvv = View.inflate(GriedView6_XiangQing.this, R.layout.fenxiang_popwindow, null);
                //QQ好友分享
                ...
                qq_friends.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        new ShareAction(GriedView6_XiangQing.this).setPlatform(SHARE_MEDIA.QQ)
                                .withText("hello")
...
//                点击popWindow后背景变暗
            ...
            case R.id.look_more_gouwuche:
                Cart_Dao dao=new Cart_Dao(this);
                dao.add(img,name,price,old_price);
                break;
        }
    }
    ...
    private UMShareListener umShareListener = new UMShareListener() {
        ...
        public void onResult(SHARE_MEDIA platform) {
            ...
            Toast.makeText(GriedView6_XiangQing.this, platform + " 分享成功啦", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onError(SHARE_MEDIA platform, Throwable t) {
            Toast.makeText(GriedView6_XiangQing.this, platform + " 分享失败啦", Toast.LENGTH_SHORT).show();
            if (t != null) {
        ...
        public void onCancel(SHARE_MEDIA platform) {
            Toast.makeText(GriedView6_XiangQing.this, platform + " 分享取消了", Toast.LENGTH_SHORT).show();
        }
    };
}
