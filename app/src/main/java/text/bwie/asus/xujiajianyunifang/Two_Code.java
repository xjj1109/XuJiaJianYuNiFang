...
public class Two_Code extends AppCompatActivity {
    ...
    Handler h=new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            two_code_img.setImageBitmap(qrBitmap);
        }
    };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_two__code);
        two_code_img = (ImageView) findViewById(R.id.two_code_img);
        TwoCode();
    }
